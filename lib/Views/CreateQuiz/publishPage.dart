...
class publishPage extends StatefulWidget {
  ...
  publishPage(
      {required this.questions, required this.answers, required this.quizType});
...
class _publishPageState extends State<publishPage> {
  ...
  void addNumberOfQuestions(
      String quizID, int numQuestions, bool isTimed, int time) async {
  ...
  Future<void> _publish() async {
    if (_formKey.currentState!.validate()) {
      ...
      addNumberOfQuestions(await service.getQuizID(), widget.questions.length,
          isTimed, timeLimit);
